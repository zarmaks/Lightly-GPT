...
try:
    ...
    st.warning("geopy package not installed. Location-based filtering will be disabled.")
...
def filter_by_location(location_input):
    ...
    try:
        ...
        is_coords = ',' in location_input and all(c in "0123456789,.-" for c in location_input.replace(' ', ''))
